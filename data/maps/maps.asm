...
MapGroup_Haiteku:
	...
	map HaitekuWestRouteGate, TILESET_GATE, GATE, LANDMARK_HAITEKU_WEST_ROUTE_OCEAN
...
MapGroup_Fonto:
	...
	map FontoRouteGate1, TILESET_GATE, GATE, LANDMARK_FONTO_ROUTE_1
	map FontoRouteGate2, TILESET_GATE, GATE, LANDMARK_FONTO_ROUTE_4
	map FontoRouteGate3, TILESET_GATE, GATE, LANDMARK_FONTO_ROUTE_5
...
MapGroup_Baadon:
	...
	map BaadonRouteGateWest, TILESET_GATE, GATE, LANDMARK_BAADON_ROUTE_1
	map BaadonRouteGateNewtype, TILESET_GATE, GATE, LANDMARK_BAADON_ROUTE_3
	...
	map BaadonHouse1, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_BAADON
...
MapGroup_Bull:
	...
	map BullForestRouteGateStand, TILESET_GATE, GATE, LANDMARK_BULL_FOREST_ROUTE_2
	map BullMart, TILESET_MART, INDOOR, LANDMARK_BULL_FOREST
	map BullHouse1, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_BULL_FOREST
